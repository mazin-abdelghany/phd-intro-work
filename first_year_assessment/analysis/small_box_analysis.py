...
def _(pd):
    ...
    small_box_rand = pd.read_csv(filepath_or_buffer="/tf/2026-04-t20/random_search_experiments/small_box_ss_change.csv")

    small_box_bo = pd.read_csv(filepath_or_buffer="/tf/2026-04-t20/bayes_opt_experiments/small_box_bo.csv")

    # importing the corrected data
    small_box_sim_ann = pd.read_csv(filepath_or_buffer="/tf/2026-04-t21/simulated_annealing_experiments/small_box_t100_neigh2_corrected.csv")
