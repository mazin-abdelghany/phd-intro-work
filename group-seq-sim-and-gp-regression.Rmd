...
For $\theta = 0.5$, i.e., under the alternative $\delta$:
```{r}
n1 <- 20
n2 <- 40
...
mean_0 <- c(theta_1 * sqrt(n1/ (2*sigma) ),
...
The following equation is used to calculate the probability of stopping at Analysis 3 in the example on Slide 16:
